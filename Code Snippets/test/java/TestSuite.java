...
import test.resources.services.LiquorServiceTest;
import test.resources.services.RestServiceTest;
import test.resources.services.ScaleServiceTest;
import test.resources.services.UserServiceTest;
...
@RunWith(Suite.class)
@Suite.SuiteClasses({
	LiquorServiceTest.class, RestServiceTest.class, UserServiceTest.class, ScaleServiceTest.class
})
