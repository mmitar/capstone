...
<div class="pad-20">
	...
	<form:form class="form" method="POST" modelAttribute="liquor" action="${pageContext.request.contextPath}/liquor/editLiquor">
	<h2>Edit Liquor</h2>
		...
		<div class="newline-elements">
			...
			<form:input  type="number" min="0" max="1.5" step="0.01" path="liquidVolume" placeholder="Liquid Volume (liters)" required="true"/>
			</div>
		</div>
		...
		<div class="newline-elements">
			...
			<form:input type="number" min="0" max="100" path="overflow" placeholder="Overflow Quantity" required="true"/>
			</div>
		</div>
		...
		<div class="newline-elements">
			...
			<form:input type="number" min="0" max="100" path="alertLevel" placeholder="Alert Level Quantity" required="true"/>
			</div>
		</div>
		
		<input class="btn-green font-bold mgn-col-10" type="submit" value="Save Changes"/>
		
		<a class="btn btn-red mgn-col-10 font-bold" href="${pageContext.request.contextPath}/liquor/listLiquor">Cancel</a>
			
		<a class="btn btn-white mgn-10 font-bold" href="${pageContext.request.contextPath}/liquor/gotoDeleteLiquor/${liquor.liquorCode}">Delete</a>
